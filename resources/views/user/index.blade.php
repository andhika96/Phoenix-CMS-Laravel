...
@section('content')
    <div class="arv6-box p-4" id="ph-app">
        <div id="ph-app-listdata" class="ph-fetch-listdata" data-url="{{ url('awesome_admin/user/') }}">
            <div class="mb-3">
                <div class="d-md-flex justify-content-between align-items-center border-bottom pb-3">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-auto text-md=,kend">
                            <button type="submit" class="btn btn-success font-size-inherit" data-bs-toggle="modal"
            ...
            <div class="toast ph-notice-toast position-relative bg-transparent align-items-center border-0" role="alert"
            ...
            <div v-else-if="responseStatus === 'failed'" class="ph-data-status text-center text-danger h5 p-5"
                style="display: none;">
                @{{ responseMessage }}
            </div>

            <div v-else class="ph-data-load" style="display: none">
            ...
            <!-- Modal -->
            <div class="modal fade" id="formSubmitModal" tabindex="-1" aria-labelledby="formSubmitModal"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="formSubmitModal">Create New User</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body" id="ph-form-submit">
                            <form action="{{ route('api.v1.user.store') }}" method="post" ref="formHTML"
                                @submit.prevent="submitData" form-file-reset="true">
                                <div class="mb-3">
        ...
        <div class="ph-fetch-list-detaildata" data-url="{{ route('api.v1.user.show', ['idOrSlug' => 1]) }}">
